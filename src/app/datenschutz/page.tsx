...
export default function DatenschutzPage() {
  return (
    <div className="min-h-screen bg-[#f8f4ef]">
      <div className="bg-[#1a3a5c] text-white py-12 px-4">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14 space-y-8 text-gray-700 text-sm leading-relaxed">
        <section>
          <h2 className="font-serif text-xl font-bold text-[#1a3a5c] mb-3">1. Datenschutz auf einen Blick</h2>
          <p>Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren personenbezogenen Daten passiert, wenn Sie diese Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können.</p>
        </section>
        <section>
          <h2 className="font-serif text-xl font-bold text-[#1a3a5c] mb-3">2. Datenerfassung auf dieser Website</h2>
          <h3 className="font-semibold text-[#1a3a5c] mb-2">Wer ist verantwortlich für die Datenerfassung?</h3>
          ...
          <h3 className="font-semibold text-[#1a3a5c] mb-2 mt-4">Welche Daten erfassen wir?</h3>
        ...
        <section>
          <h2 className="font-serif text-xl font-bold text-[#1a3a5c] mb-3">3. Ihre Rechte</h2>
        ...
        <section>
          <h2 className="font-serif text-xl font-bold text-[#1a3a5c] mb-3">4. Cookies</h2>
          <p>Diese Website verwendet technisch notwendige Cookies für den Betrieb der Plattform. Mehr dazu in unserer <a href="/cookies" className="text-[#1a3a5c] underline">Cookie-Richtlinie</a>.</p>
        </section>
      </div>
    </div>
  )
