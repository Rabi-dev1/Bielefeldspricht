  ...
  return (
    <div className="min-h-screen bg-[#f9fafb]">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14 space-y-10 text-gray-700 leading-relaxed">
        <section>
          <h2 className="font-serif text-3xl font-bold text-[#15803d] mb-4">Bielefeld gehört euch</h2>
        ...
        <section>
          <h2 className="font-serif text-2xl font-bold text-[#15803d] mb-4">Für wen ist Bielefeld spricht?</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={p.title} className="bg-white rounded-2xl p-5 border border-[#e5e7eb]">
                <h3 className="font-semibold text-[#15803d] mb-1">{p.title}</h3>
        ...
        <section>
          <h2 className="font-serif text-2xl font-bold text-[#15803d] mb-4">Was passiert mit meinem Anliegen?</h2>
        ...
        <div className="pt-4 flex flex-col sm:flex-row gap-3">
          <Link href="/melden" className="inline-flex items-center justify-center gap-2 bg-[#15803d] text-white font-semibold px-6 py-3.5 rounded-full hover:bg-[#166534] transition-colors">
            Anliegen melden <ArrowRight className="w-4 h-4" />
          </Link>
          <Link href="/themen" className="inline-flex items-center justify-center gap-2 border-2 border-[#15803d] text-[#15803d] font-semibold px-6 py-3.5 rounded-full hover:bg-[#f0fdf4] transition-colors">
            Themen entdecken
          </Link>
        </div>
      </div>
