  ...
  return (
    <div className="min-h-screen bg-[#f8f4ef]">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14 space-y-8 text-gray-700">
        <section>
          <h2 className="font-serif text-xl font-bold text-[#1a3a5c] mb-3">Angaben gemäß § 5 TMG</h2>
          <p>Marvin Lübbert<br />Bielefeld spricht<br />Musterstraße 12<br />33602 Bielefeld</p>
        </section>
        <section>
          <h2 className="font-serif text-xl font-bold text-[#1a3a5c] mb-3">Kontakt</h2>
          <p>Telefon: 0521 / 123 456 78<br />E-Mail: hallo@bielefeldspricht.de</p>
        </section>
        <section>
          <h2 className="font-serif text-xl font-bold text-[#1a3a5c] mb-3">Verantwortlich für den Inhalt</h2>
          <p>Marvin Lübbert<br />Musterstraße 12<br />33602 Bielefeld</p>
        </section>
        <section>
          <h2 className="font-serif text-xl font-bold text-[#1a3a5c] mb-3">Haftungsausschluss</h2>
        ...
        <section>
          <h2 className="font-serif text-xl font-bold text-[#1a3a5c] mb-3">Streitschlichtung</h2>
